...
def parse_args():
    ...
    parser.add_argument("--seed", type=int, default=2022)###2022
    parser.add_argument('--data-dir', default='F:/CrowdCounting(rgbt)/DEFNet-main/RGBT-CC',
                        help='training data directory')
    parser.add_argument('--save-dir', default='F:/CrowdCounting(rgbt)/DEFNet-main/save_D',
